...
class AuthService {
  ...
  Future<void> login({
    ...
    final resolvedEmail = resolvedData?['resolvedEmail'];

    if (resolvedEmail == null || resolvedEmail.toString().isEmpty) {
      throw ApiException('Invalid employee credentials or company slug.');
    }
    ...
    if (token == null || token.trim().isEmpty) {
      throw ApiException('Login succeeded, but the authentication token was not returned.');
    }
